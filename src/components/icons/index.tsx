...
// 材料管理图标
export const MaterialsIcon = ({ className = "", size = 20 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
// 入库管理图标
export const InboundIcon = ({ className = "", size = 20 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.293 2.293c-.63.63-.184 1.707.707 1.707H19M7 13v4a2 2 0 002 2h4a2 2 0 002-2v-1M9 9h10V7a2 2 0 00-2-2H9v4z"
    />
  </svg>
);

// 供应商管理图标
export const SuppliersIcon = ({ className = "", size = 20 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
// 登录图标
export const LoginIcon = ({ className = "", size = 32 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const AlertIcon = ({ className = "", size = 20 }: IconProps) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.892-.833-2.464 0L4.34 16.5c-.77.833.192 2.5 1.732 2.5z"
    />
  </svg>
);
...
// 眼睛关闭图标（隐藏）
export const EyeSlashIcon = ({ className = "", size = 16 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
